...
1. **SYM1: Symbol and Import Metadata** (Completed)
2. **CALL1: Execution Call Plans** (Completed)
3. **RES1: Expanded Resource Model** (Completed)
4. **TINP1: Target Input Records** (Completed)
