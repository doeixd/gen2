...
import {
  ...
  createRequirementNamespace,
  createProviderNamespace,
  createStateNamespace,
  createMergeNamespace,
  createOfflineNamespace,
  createStorageLocationNamespace,
  createScheduleNamespace,
  createCronNamespace,
  createWorkflowNamespace,
...
const buildGenNamespace = <C extends GenConfig = GenConfig>(
  ...
  plan: createPlanNamespace<C>(ctx),
  context: createContextNamespace<C>(ctx),
  requirement: createRequirementNamespace<C>(ctx),
  provider: createProviderNamespace<C>(ctx),
  state: createStateNamespace<C>(ctx),
  merge: createMergeNamespace<C>(),
  offline: createOfflineNamespace<C>(ctx),
  schedule: createScheduleNamespace<C>(ctx),
  cron: createCronNamespace<C>(ctx),
  workflow: createWorkflowNamespace<C>(ctx),
